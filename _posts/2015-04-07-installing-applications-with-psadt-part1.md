...
[Download the latest version of the toolkit](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/releases) and extract it.  We'll want to maintain a "clean" copy of these files so we can copy them into future builds.
